...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-10-2023 a las 19:54:21
...
(12, 20, 4, '2023-10-25', 500.00, 'Efectivo', 'Avenida Timoteo', '15125', '2023-11-28');
...
--
ALTER TABLE `tbl_pedidos`
  MODIFY `idPedido` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
COMMIT;
